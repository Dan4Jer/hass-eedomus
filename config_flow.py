...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_PHP_FALLBACK_ENABLED, default=DEFAULT_PHP_FALLBACK_ENABLED): bool,
        vol.Optional(CONF_PHP_FALLBACK_SCRIPT_NAME, default=DEFAULT_PHP_FALLBACK_SCRIPT_NAME): str,
        vol.Optional(CONF_PHP_FALLBACK_TIMEOUT, default=DEFAULT_PHP_FALLBACK_TIMEOUT): int,
        vol.Optional(CONF_PHP_FALLBACK_LOG_ENABLED, default=DEFAULT_PHP_FALLBACK_LOG_ENABLED): bool,
    }
)
        ...
        if api_eedomus_enabled:
            ...
            client = EedomusClient(
                ...
                config_entry=ConfigEntry(
                    ...
                    minor_version = None,
                    options={
                        CONF_PHP_FALLBACK_ENABLED: data.get(CONF_PHP_FALLBACK_ENABLED, DEFAULT_PHP_FALLBACK_ENABLED),
                        CONF_PHP_FALLBACK_SCRIPT_NAME: data.get(CONF_PHP_FALLBACK_SCRIPT_NAME, DEFAULT_PHP_FALLBACK_SCRIPT_NAME),
                        CONF_PHP_FALLBACK_TIMEOUT: data.get(CONF_PHP_FALLBACK_TIMEOUT, DEFAULT_PHP_FALLBACK_TIMEOUT),
                        CONF_PHP_FALLBACK_LOG_ENABLED: data.get(CONF_PHP_FALLBACK_LOG_ENABLED, DEFAULT_PHP_FALLBACK_LOG_ENABLED)
                    },
