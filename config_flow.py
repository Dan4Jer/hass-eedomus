...
from .const import (
    ...
    CONF_FALLBACK_ENABLED, CONF_FALLBACK_SCRIPT_NAME, CONF_FALLBACK_TIMEOUT, CONF_FALLBACK_LOG_ENABLED,
    DEFAULT_FALLBACK_ENABLED, DEFAULT_FALLBACK_SCRIPT_NAME, DEFAULT_FALLBACK_TIMEOUT, DEFAULT_FALLBACK_LOG_ENABLED
)
...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_FALLBACK_SCRIPT_NAME, default=DEFAULT_FALLBACK_SCRIPT_NAME): str,
            ...
            client = EedomusClient(
                ...
                config_entry=ConfigEntry(
                    ...
                    options={
                        ...
                        CONF_FALLBACK_SCRIPT_NAME: data.get(CONF_FALLBACK_SCRIPT_NAME, DEFAULT_FALLBACK_SCRIPT_NAME),
