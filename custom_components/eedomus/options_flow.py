...
from .const import (
    ...
    DEFAULT_CONF_ENABLE_WEBHOOK,
    DEFAULT_CONF_API_PROXY_DISABLE_SECURITY,
    DEFAULT_CONF_PHP_FALLBACK_ENABLED,
    DEFAULT_CONF_PHP_FALLBACK_SCRIPT_NAME,
    DEFAULT_CONF_PHP_FALLBACK_TIMEOUT,
    DEFAULT_CONF_HTTP_REQUEST_TIMEOUT,
    CONF_API_PROXY_DISABLE_SECURITY,
    CONF_PHP_FALLBACK_ENABLED,
    CONF_PHP_FALLBACK_SCRIPT_NAME,
    CONF_PHP_FALLBACK_TIMEOUT,
    ...
    async def async_step_init(self, user_input=None):
            ...
            if user_input is not None:
                ...
                options = {
                    ...
                    CONF_ENABLE_SET_VALUE_RETRY: user_input.get(CONF_ENABLE_SET_VALUE_RETRY, current_config.get(CONF_ENABLE_SET_VALUE_RETRY, DEFAULT_CONF_ENABLE_SET_VALUE_RETRY)),
                    CONF_ENABLE_WEBHOOK: user_input.get(CONF_ENABLE_WEBHOOK, current_config.get(CONF_ENABLE_WEBHOOK, DEFAULT_CONF_ENABLE_WEBHOOK)),
                    CONF_API_PROXY_DISABLE_SECURITY: user_input.get(CONF_API_PROXY_DISABLE_SECURITY, current_config.get(CONF_API_PROXY_DISABLE_SECURITY, DEFAULT_CONF_API_PROXY_DISABLE_SECURITY)),
                    CONF_PHP_FALLBACK_ENABLED: user_input.get(CONF_PHP_FALLBACK_ENABLED, current_config.get(CONF_PHP_FALLBACK_ENABLED, DEFAULT_CONF_PHP_FALLBACK_ENABLED)),
                    CONF_PHP_FALLBACK_SCRIPT_NAME: user_input.get(CONF_PHP_FALLBACK_SCRIPT_NAME, current_config.get(CONF_PHP_FALLBACK_SCRIPT_NAME, DEFAULT_CONF_PHP_FALLBACK_SCRIPT_NAME)),
                    CONF_PHP_FALLBACK_TIMEOUT: user_input.get(CONF_PHP_FALLBACK_TIMEOUT, current_config.get(CONF_PHP_FALLBACK_TIMEOUT, DEFAULT_CONF_PHP_FALLBACK_TIMEOUT)),
                    CONF_HTTP_REQUEST_TIMEOUT: user_input.get(CONF_HTTP_REQUEST_TIMEOUT, current_config.get(CONF_HTTP_REQUEST_TIMEOUT, DEFAULT_CONF_HTTP_REQUEST_TIMEOUT)),
                }
