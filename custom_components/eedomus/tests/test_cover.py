...
async def test_cover_initialization():
    ...
    device_info = {"periph_id": "cover_123", "name": "Test Cover", "usage_id": "48"}
...
async def test_cover_closed_state():
    ...
    mock_coordinator = AsyncMock()
    mock_coordinator.data = {"cover_123": {"value": "closed", "position": 0}}
...
async def test_cover_set_position():
    ...
    mock_coordinator = AsyncMock()
    mock_coordinator.data = {"cover_123": {"value": "open", "position": 50}}
...
async def test_cover_with_energy_sensor():
    ...
    mock_coordinator = AsyncMock()
    mock_coordinator.data = {
        "cover_123": {"name": "Test Cover", "value": "open", "position": 100},
        "cover_123_consumption": {"consumption": 25.5, "current_power": 50},
    }
