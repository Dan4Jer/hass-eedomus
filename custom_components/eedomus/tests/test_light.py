...
import pytest
from homeassistant.components.light import ATTR_BRIGHTNESS, ATTR_RGBW, ColorMode
...
async def test_light_off_state():
    ...
    mock_coordinator = AsyncMock()
    mock_coordinator.data = {"light_123": {"value": "off", "brightness": 0}}
...
async def test_light_turn_on():
    ...
    mock_coordinator = AsyncMock()
    mock_coordinator.data = {
        "light_123": {"value": "off", "brightness": 0, "value_list": ["on", "off"]}
    }

    device_info = {"periph_id": "light_123", "name": "Test Light"}
...
async def test_light_turn_off():
    ...
    mock_coordinator = AsyncMock()
    mock_coordinator.data = {"light_123": {"value": "on", "value_list": ["on", "off"]}}
...
async def test_light_with_consumption_child():
    ...
    device_info = {
        ...
        "usage_id": "1",
        "color_mode": "brightness",
        "children": [{"periph_id": "light_123_consumption", "usage_id": "26"}],
    }
