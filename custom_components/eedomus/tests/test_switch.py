...
async def test_switch_with_consumption_child():
    ...
    device_info = {
        ...
        "usage_id": "37",
        "children": [
            {"periph_id": "switch_123_consumption", "usage_id": "26", "name": "Consommation"}
        ]
    }
...
async def test_switch_consumption_only_device():
    ...
    device_info = {
        ...
        "children": [
            {"periph_id": "consumption_monitor_power", "usage_id": "26", "name": "Puissance"}
        ]
    }
    ...
    assert "conso" in device_info["name"].lower() or "consommation" in device_info["name"].lower()
    
    # Check if it has consumption children
    has_consumption_children = any(
        child.get("usage_id") == "26" 
