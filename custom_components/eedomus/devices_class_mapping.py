...
DEVICES_CLASS_MAPPING = {
    ...
    "132": {"ha_entity": None, "exceptions": [], "justification": "Classe 132 = WakeUp (non fonctionnelle)."},
    "114": {"ha_entity": None, "exceptions": [], "justification": "Classe 114 = Configuration (non fonctionnelle)."},
    "134": {"ha_entity": None, "exceptions": [], "justification": "Classe 134 = Version (non fonctionnelle)."},
    "115": {"ha_entity": None, "exceptions": [], "justification": "Classe 115 = ManufacturerSpecific (non fonctionnelle)."},
    "142": {"ha_entity": None, "exceptions": [], "justification": "Classe 142 = CRC-16 Encapsulation (non fonctionnelle)."},
}
